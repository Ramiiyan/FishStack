...
public class CustomerInfo2 {
    ...
    public CustomerInfo2(String dateOfpur, String productid, String productname, Double price, Integer qty, Double subttl) {
    ...
    //public void setCustomerID(int userid) {customerID.set(userid);}
